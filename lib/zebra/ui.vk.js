...
var tooltip = new ui.Panel({
        border    : new ui.Border("#CCCCCC", 1, 16),
        padding   : 12,
        background: "white",
        layout    : new L.FlowLayout("center", "top"),
        kids      : [
            new ui.Label("").properties({
                font   : new ui.Font("Arial", "bold",  28),
                color  : "#2222FF"
            })
        ]
    },
    [
        function setValue(lab) {
            this.kids[0].setValue(lab);
        }
    ]);
...
// 2)
//
// 2) "ABCD" - multiple characters key
//  { ch: "A", alternative: {  ... }  }
//
// 1) General pattern
//   {
    ...
    function $clazz () {
        ...
        this.KeysPopupPan = Class(ui.Panel, [
            ...
            function() {
                ...
                this.setBackground("rgba(200,200,200,0.8)");
            }
        ]);
